...
public class HRWKPSPublicSoap
{
    ...
    public HRWKPSPublicSoap(){}

    public HRWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HRWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HRWExtendedSoapSerializationEnvelope envelope= new HRWExtendedSoapSerializationEnvelope(HRWExtendedSoapSerializationEnvelope.VER11);
