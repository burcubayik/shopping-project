...
public class HRWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HRWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HRWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HRWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HRWDateTimeConverter dateTimeConverter = new HRWStandardDateTimeConverter();

    public HRWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HRWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HRWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HRWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HRWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HRWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
